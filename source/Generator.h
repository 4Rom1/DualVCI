...
//
uint32_t GeneratorXPoz (int NMode, int Eccit,  int **XPolSupPos, uint32_t SizeGenOld, int MaxDeg);
...
stored in IJRez. The space H*(A) is fetched at each iteration where A is the set of added basis functions.*/
//
