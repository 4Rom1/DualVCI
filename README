...
an example of implementation is given within the module Transition (see under).
 ...
 *-FinalBasis.in*, *-Vectors.bin* (if Printout=1).
 ...
 Then the module **Transitions** allows to get the transition moments <Psi_0 |Op|Psi_n> where
